...
declare global {
  export type SvgName = 'arrow-right' | 'backend' | 'close-2' | 'close' | 'data-visualization' | 'download' | 'frontend' | 'fullstack' | 'github' | 'integration' | 'linkedin-footer' | 'linkedin' | 'logo' | 'optimization-refactoring' | 'telegram' | 'upwork' | 'default'
  interface Window {
    ust: {
